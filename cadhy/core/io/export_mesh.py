...
def export_cfd_package(obj, output_dir: str, base_name: str = "cfd_domain", formats: List[ExportFormat] = None) -> dict:
    """
    ...
    for fmt in formats:
        ...
        results[fmt.value] = {"success": success, "filepath": filepath if success else None}
