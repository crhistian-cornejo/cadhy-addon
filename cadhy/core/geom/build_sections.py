...
from ..model.sections_params import SectionsParams, SectionCut, SectionsReport
from .build_channel import get_curve_length, evaluate_curve_at_parameter, generate_section_vertices
...
def create_section_curves(
    report: SectionsReport,
    collection_name: str = "CADHY_Sections"
