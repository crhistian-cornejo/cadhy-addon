...
from ..model.channel_params import ChannelParams, SectionType, SectionProfile
...
def create_channel_object(name: str, vertices: List[Vector], faces: List[Tuple[int, ...]], collection_name: str = "CADHY_Channels") -> 'bpy.types.Object':
    """
