...
class CADHY_PT_Updates(Panel):
    ...
    def draw(self, context):
        ...
        col.operator("wm.url_open", text="Report Issue", icon='ERROR').url = "https://github.com/cadhy/cadhy-addon/issues"
...
class CADHY_OT_CheckUpdates(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        self.report({'INFO'}, f"CADHY {CADHY_VERSION_STRING} - Update check not yet implemented. Visit cadhy.app for updates.")
        return {'FINISHED'}
