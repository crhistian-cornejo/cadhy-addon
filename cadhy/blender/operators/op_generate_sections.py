...
from ...core.geom.build_sections import create_section_curves, create_section_meshes, generate_sections
...
class CADHY_OT_GenerateSections(Operator):
    ...
    create_meshes: BoolProperty(
        name="Create Meshes", description="Create filled mesh sections instead of curves", default=False
    )
