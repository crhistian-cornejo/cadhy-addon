...
from ...core.util.naming import get_cfd_domain_name, COLLECTION_CFD
    ...
    def execute(self, context):
        ...
        with OperationLogger("Build CFD Domain", self) as logger:
            ...
            if cfd_info.is_valid:
                logger.set_success(f"CFD Domain '{domain_name}' created. Volume: {cfd_info.volume:.3f} m³. Mesh is valid for CFD.")
            else:
                warnings = []
