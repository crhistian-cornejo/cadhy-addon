...
class CADHYSceneSettings(PropertyGroup):
    ...
    georef_enabled: BoolProperty(
        name="Georeferencing Enabled",
        description="Enable georeferencing for coordinates",
        default=False
    )
    
    georef_crs: StringProperty(
        name="CRS",
        description="Coordinate Reference System (e.g., EPSG:32618)",
        default=""
    )
    ...
    cfd_enabled: BoolProperty(
        name="Generate CFD Domain",
        description="Generate CFD fluid domain alongside channel",
        default=True
    )
