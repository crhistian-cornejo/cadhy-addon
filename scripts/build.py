...
EXCLUDE_PATTERNS = [
    ...
    ".venv",
    "node_modules",
    # Development only - NOT needed for addon to work
    "tests",
    "README.md",
    "CONTRIBUTING.md",
    "*.md",
...
def main():
    ...
    parser.add_argument("--no-version", action="store_true", help="Don't include version in filename")
    ...
    zip_path = build_addon(output_dir=args.output, include_version=not args.no_version)
